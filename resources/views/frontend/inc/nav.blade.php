...
@endif
<!-- Top Bar -->
<div class="top-navbar bg-white border-bottom border-soft-secondary z-1035" style="background: #ffffff !importantcolor: #080808 !important;">
    <div class="container">
        <div class="row">
...
@endphp
@if($header_logo != null)
    <img src="{{ uploaded_asset($header_logo) }}" alt="{{ env('APP_NAME') }}" class="mw-100 h-30px h-md-40px" height="40" style="height: 123px;position: fixed;z-index: 100000;left: 170px;top: 12px;">
@else
...
<header class="@if(get_setting('header_stikcy') == 'on') sticky-top @endif z-1020 bg-white border-bottom shadow-sm">
    <div class="position-relative logo-bar-area z-1" style="height: 100px;padding-top: 20px;padding-bottom: 130px;">
