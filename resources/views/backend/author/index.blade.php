...
<div class="card">
    <form class="" id="sort_customers" action="" method="GET">
        <div class="card-header row gutters-5">
            <div class="col">
                <h5 class="mb-0 h6">{{translate('Authors')}}</h5>
            </div>
            ...
            <table class="table aiz-table mb-0">
                <thead>
                    <tr>
                        ...
                        <th data-breakpoints="lg">{{translate('Author Description')}}</th>
                ...
                <tbody>
                    @foreach($authors as $key => $author)
                            ...
                            <tr>
                                ...
                                <td><i class="fa fa-ban text-danger" aria-hidden="true"></i>{{$author->author_name}}</td>
                                <td>{{$author->email}}</td>
